 ...
 * @retval Member of @ref TM_MPU6050_Result_t enumeration
 */
MPU6050_Result_t TM_MPU6050_SetAccelerometer(MPU6050_t* DataStruct, MPU6050_Accelerometer_t AccelerometerSensitivity);
 ...
 * @retval Member of @ref TM_MPU6050_Result_t enumeration
 */
MPU6050_Result_t TM_MPU6050_SetDataRate(MPU6050_t* DataStruct, uint8_t rate);
 ...
 * @retval Member of @ref TM_MPU6050_Result_t enumeration
 */
MPU6050_Result_t TM_MPU6050_DisableInterrupts(MPU6050_t* DataStruct);
 ...
 * @retval Member of @ref TM_MPU6050_Result_t enumeration
 */
MPU6050_Result_t TM_MPU6050_ReadInterrupts(MPU6050_t* DataStruct, MPU6050_Interrupt_t* InterruptsStruct);
 ...
 */
MPU6050_Result_t TM_MPU6050_ReadAccelerometer(MPU6050_t* DataStruct);
 ...
 *            - Other: in other cases
 */
MPU6050_Result_t TM_MPU6050_ReadAll(MPU6050_t* DataStruct);
