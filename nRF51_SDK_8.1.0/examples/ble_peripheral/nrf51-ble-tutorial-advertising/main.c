...
#define DEVICE_NAME                     "HELLO"                                /**< Name of device. Will be included in the advertising data. */
...
//    uint8_t             flags       = BLE_ADVDATA_FULL_NAME; //Defines how your device is seen (or not seen) by other devices
...
//    advdata.p_tx_power_level 		= &tx_power;
    ...
    uint8_t respones_data[]            	= "A lot of information"; // Our data to adverise
    manuf_data_response.company_identifier       = 0x0059; // Nordics company ID
    manuf_data_response.data.p_data              = respones_data;     
    manuf_data_response.data.size                = sizeof(respones_data);
...
//    ble_advdata_manuf_data_t                manuf_data_response;
//    uint8_t                                 data_response[] = "Twenty_seven_bytes_of_data"; // Remember there is a 0 terminator at the end of string
